...
#include "game\jobs\command\auxiliary\mech_crew.dm"
...
#include "modules\vehicles\hardpoints\holder\tank_turret.dm"
#include "modules\vehicles\hardpoints\support\smoke.dm"
